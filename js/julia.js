...
function actualizar() {
  o = {
    length: 640,
    width: 480,
    c: [parseFloat(document.getElementsByName("c1")[0].value), parseFloat(document.getElementsByName("c2")[0].value)], // c = x + iy will be [x, y]
  ...
  document.getElementById('a').getContext("2d").clearRect(0, 0, document.getElementById('a').width, document.getElementById('a').height);
